...
def main():
    ...
    data_path = data_path = home_dir.as_posix() + "/" + input_file
    ...
    # FIX: Drop the text columns AND the target all at the same time
    columns_to_drop = ['id', 'pickup_datetime', 'dropoff_datetime', 'pickup_date', TARGET]
    X = train_features.drop(columns_to_drop, axis=1, errors='ignore')
